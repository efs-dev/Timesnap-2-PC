...
namespace sharpPDF
{
	...
	public class pdfPage : IWritable
	{
        ...
        {
            return "[\n" + Text.Aggregate((x, y) => x + ",\n" + y) + "]";
        }
        public System.Collections.Generic.List<string> Text = new System.Collections.Generic.List<string>();
		...
		public void addText(string newText, int X, int Y, predefinedFont fontType, int fontSize, string type)
		{
            Text.Add("   {\"text\": \"" + newText.Replace("\"", "\\\"") + "\", \"x\":" + X + ", \"y\": " + Y + ", \"font\":\"" + Enum.GetName(typeof(predefinedFont), fontType) + "\", \"fontSize\":" + fontSize + ", \"type\":\"" + type + "\"}");
