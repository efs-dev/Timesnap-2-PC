...
public class GvrPointerInputModuleImpl 
{
  ...
  private void HandleTriggerDown() {
    ...
    // NOTICE: @JEPHRON MADE CHANGES HERE, TODO GET OUT OF THIS FILE
    var currentObject = GetCurrentGameObject(); // Get the pointer target
    if (currentObject == null) {
        ModuleController.eventSystem.SetSelectedGameObject(null, CurrentEventData);
    } else if (currentObject.GetComponentInParent<INonSelectable>() == null) {
