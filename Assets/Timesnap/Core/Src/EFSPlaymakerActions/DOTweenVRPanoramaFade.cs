...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenVRPanoramaFade : FsmStateAction
    {
        [RequiredField]
        [CheckForComponent(typeof(VRPanorama))]
        ...
        public override void OnEnter()
        {
            ...
            tweener = DOTween.To(() => Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<VRPanorama>().Alpha, x => Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<VRPanorama>().Alpha = x, to.Value, duration.Value);
